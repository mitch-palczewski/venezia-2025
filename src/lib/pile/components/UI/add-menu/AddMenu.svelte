...
{#if previewImage()}
    ...
    >
        <div 
            ...
            class=" border border-white/10 p-1 rounded-sm shadow-2xl  w-20 sm:w-25 md:w-50 h-20 sm:h-25 md:h-50 flex flex-col items-center justify-center aspect-square"
        >
            <img 
                src={previewImage()} 
                alt="Asset preview" 
